        ...
        <View className="flex-1 bg-background" style={styles.page}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Text style={styles.subtitle}>
                    We will send OTP to verify your phone number.
                </Text>
                ...
                <View style={styles.field}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                        ...
                        <SelectContent>
                            <SelectItem key="township1" label="(999) 111-0000" value="township1" />
                        </SelectContent>
                    </Select>
                    <Input placeholder="(999) 111-0000" />
                    </View>
                </View>

                <Button style={styles.continueButton} onPress={() => router.push('./otp')}>
                    <Text>Send OTP</Text>
                </Button>
            </ScrollView>
        </View>
